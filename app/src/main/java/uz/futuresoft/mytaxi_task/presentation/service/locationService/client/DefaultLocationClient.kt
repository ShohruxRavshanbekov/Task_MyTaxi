...
class DefaultLocationClient(
    ...
    override fun getLocationUpdates(interval: Long): Flow<Location> {
        return callbackFlow {
            if (!context.hasLocationPermission()) throw LocationClient.LocationException("Joylashuvni olish uchun ruxsat berilmagan")
            ...
            if (!isGpsEnabled && !isNetworkEnabled) throw LocationClient.LocationException("GPS yoqilmagan")
